...
namespace Tero
{
    public class E2_GranadeKnockBack : KnockBack
    {
        ...
        private Death death;
        public E2_GranadeKnockBack(Entity entity, FinateStateMachine stateMachine, string animBoolName, D_ChargeState stateData, Enemy2 enemy) : base(entity, stateMachine, animBoolName, null)
        {
            this._enemy = enemy;
        }

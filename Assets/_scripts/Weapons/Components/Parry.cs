...
using Tero.Utility;
using Tero.Weapons.Modifiers;
using UnityEngine;
using static Tero.Combat.Parry.CombatParryUtilities;
...
namespace Tero.Weapons.Components
{
    ...
    public class Parry : WeaponComponent<ParryData, AttackParry>
    {
        ...
        protected override void Start()
        {
            ...
            damageReceiver = Core.getCoreComponents<DamageReceiver>();
            knockBackReceiver = Core.getCoreComponents<KnockBackReceiver>();
            poiseDamageReceiver = Core.getCoreComponents<PoiseDamageReceiver>();

            movement = Core.getCoreComponents<CoreSystem.Movement>();
            particleManager = Core.getCoreComponents<ParticleManager>();

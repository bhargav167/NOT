...
using UnityEngine;
    ...
    public class E2_HiddenState: HiddenState{
    ...
    public E2_HiddenState(Entity entity, FinateStateMachine stateMachine, string animBoolName, D_HideStateData stateData, Enemy2 enemy2) : base(entity, stateMachine, animBoolName, stateData)
    {
        this.enemy = enemy2;
    }

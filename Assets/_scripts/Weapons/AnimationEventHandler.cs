...
namespace Tero.Weapons
{
    public class AnimationEventHandler : MonoBehaviour
    {
        ...
        public event Action OnFireFinish;
        ...
        public event Action<bool> OnMovementSetActive;
        ...
        public void FireFinishedTrigger() => OnFireFinish?.Invoke();
        ...
        private void UseInputFireTrigger() => OnUseFire?.Invoke();
        ...
        private void SetMovementActive() => OnMovementSetActive?.Invoke(true);
        private void SetMovementInactive() => OnMovementSetActive?.Invoke(false);
